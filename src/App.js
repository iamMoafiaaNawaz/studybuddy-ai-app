    ...
    <div style={{ minHeight:"100vh", background:C.bg, fontFamily:"'Plus Jakarta Sans', sans-serif", color:C.text }}>
      ...
      {tab === "history" && (
        <div className="page-wrap" style={{ maxWidth:"860px", margin:"0 auto", padding:"40px 28px" }}>
          <h2 style={{ fontFamily:"'DM Serif Display', serif", fontWeight:400, fontSize:"30px", marginBottom:"6px" }}>Learning Journal</h2>
          <p style={{ color:"#64748B", fontSize:"14px", marginBottom:"28px" }}>Track your progress — quizzes, conversations and notes saved on this device</p>
